...
## Website Edits — ManusWebsiteEdits.docx

- [x] Publications page: 90+ → 80+ publications stat, 45+ → 49+ years of industry experience
- [x] OurTeam page: Awards & Recognition heading fixed, Graduate Students heading fixed, Penn State → Oregon State, disc → disk, Terry strengths sentence added
- [x] All pages: 90+ publications → 80+ (Home, GasManagement, HatcherySolutions, EngineeringPartners, CustomSolutions)
- [x] Patent wording updated to "15 Patents and Provisional Patents" on GasManagement page
- [x] Gas Management product page: Craig Brook 900 GPM vacuum degasser photo added centered below the two existing photos
- [x] Gas Management product page: Water jet exhauster photo added below Craig Brook photo with caption
- [x] Hatcheries page: Gas Management Solutions button link fixed to /products/gas-management
