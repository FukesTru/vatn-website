...
/**
 * Both page scans are the originals. The source PDF was lost with the Manus
 * deployment and is the only asset with no replacement, so the download
 * buttons were replaced with a request link rather than left pointing at a
 * dead file. To restore them, drop the PDF in `client/public/docs/` and
 * reinstate the two <a> buttons.
 */
const TERMS_PAGES = [
  "/images/terms-and-conditions-page-1.png",
  "/images/terms-and-conditions-page-2.png",
];
