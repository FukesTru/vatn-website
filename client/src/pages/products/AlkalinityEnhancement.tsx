      ...
      >
        ...
        <div className="container relative z-10 text-center">
          ...
          <h1 className="font-display text-white mb-5" style={{ fontSize: "clamp(2.4rem, 5vw, 3.8rem)", fontWeight: 800, lineHeight: 1.05 }}>
            ...
            <span style={{ color: "#0E9B8A" }}>Limestone-Based Treatment</span>
          </h1>
      ...
      <section className="py-16 lg:py-20" style={{ backgroundColor: "#0A1628", borderBottom: "1px solid rgba(14,155,138,0.2)" }}>
        <div className="container">
          <div className="max-w-3xl">
            <p className="section-label mb-3" style={{ color: "#0E9B8A" }}>Why Alkalinity Matters in Hatchery Water</p>
      ...
      <section className="py-20 lg:py-28" style={{ backgroundColor: "#ffffff" }}>
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            {technologies.map((t) => (
              <div key={t.title} className="p-6 bg-white" style={{ border: "1px solid #E8EEF4", borderTop: "2px solid #0E9B8A", borderRadius: "2px" }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
            ...
            <div className="p-6" style={{ backgroundColor: "#0A1628", borderRadius: "2px" }}>
              <p className="section-label mb-3" style={{ color: "#0E9B8A" }}>Patents &amp; Research</p>
