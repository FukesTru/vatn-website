          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            <div>
              ...
              <div className="flex flex-col gap-2">
                {["Forced-air packed bed strippers", "Cascade-type degassers with self-cleaning packing", "Spray nozzle reactors", "Concurrent dissolved nitrogen reduction", "Computer-modeled sizing for your site conditions"].map((item) => <div key={item} className="flex items-start gap-3"><div className="mt-1 flex-shrink-0 w-4 h-4 rounded-full flex items-center justify-center" style={{ backgroundColor: "rgba(58,140,63,0.12)" }}><div className="w-1.5 h-1.5 rounded-full" style={{ backgroundColor: "#3A8C3F" }} /></div><span className="font-body" style={{ fontSize: "0.88rem", color: "#3A5068", lineHeight: "1.6" }}>{item}</span></div>)}
              </div>
            </div>
