        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            ...
            <div>
              ...
              <p className="font-body text-white/65 mb-5" style={{ fontSize: "0.92rem", lineHeight: "1.75" }}>Performance of this patented device is related to the available head (fall), water and oxygen feed rates, influent dissolved gas levels, the number of chambers or stages employed and the presence or absence of packing within the chambers. Dr. Watten's original proprietary design software, calibration data and criteria for hydraulic loading has been applied successfully for over 30 years in a wide range of operating conditions and is available at VATN to design future LHO systems that match system configurations with target gas transfer rates.</p>
